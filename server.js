...
/**  
* @swagger  * /foods:  *    patch:  *      description: Update record to food table  *      produces:  *          - application/json  *      responses:  *          200:  *              description: Updated data to food table  *          404:  *              description: No record for given ItemId  *          422:  *              description: Errors in input object  *      parameters:  *          - name: Food  *            description: food object  *            in: body  *            required: true  *            schema:  *              $ref: '#/definitions/Food'  *  */
